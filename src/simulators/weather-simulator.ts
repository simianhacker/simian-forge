        ...
        template: {
          mappings: {
            properties: {
              ...
              'station.location.latitude': { type: 'double', meta: { description: 'Station latitude' } },
              'station.location.longitude': { type: 'double', meta: { description: 'Station longitude' } },
              ...
              'fieldsense.system.memory.total': { type: 'long', time_series_metric: 'gauge', meta: { unit: 'bytes', description: 'Total memory in bytes' } },
              'fieldsense.system.memory.used': { type: 'long', time_series_metric: 'gauge', meta: { unit: 'bytes', description: 'Used memory in bytes' } },
              'fieldsense.system.memory.free': { type: 'long', time_series_metric: 'gauge', meta: { unit: 'bytes', description: 'Free memory in bytes' } },
              'fieldsense.system.memory.cached': { type: 'long', time_series_metric: 'gauge', meta: { unit: 'bytes', description: 'Cached memory in bytes' } },
              ...
              'fieldsense.network.traffic.bytes': { type: 'long', time_series_metric: 'counter', meta: { unit: 'bytes', description: 'Network traffic in bytes' } },
